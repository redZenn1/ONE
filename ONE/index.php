...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" name="loginForm" method="post">
   ...
   <input type="radio" name="a" id="admin" value="1" checked> Pengurus
   <input type="radio" name="a" id="participants" value="2">Peserta
    <input type="radio" name="a" id="coach" value="3">Pengajar
