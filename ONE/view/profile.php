...
if ($uType==2)
{
	$userData = $Profile->getUserData($uId);
...
{
	$userData = $Profile->getAdminData($uId);
...
<header class="w3-container w3-xlarge">
  ...
  <tr>
    <td rowspan="2" width="35%"><div class="w3-container">
         <center><?php 
		if($userRole==2)
			$Profile->displayPP($id); 
		else
			$Profile->displayPA($id);	
		?><center><br>
          <!-- Button -->
          <div class="controls">
           <center><a style="align:center" href="editProfile.php?id=<?php echo $id?>"><button class="btn edit_btn" name="btnedit" >Edit</button></center>
           
           <?php 
		   if($userRole==2)
		   {?>
           		<a style="align:center" href="listOfEvent.php?id=<?php echo $id?>"><button class="btn list_btn" name="btnlist" >List of Events</button>
           		<?php 
		   } 
		   ?>
           </div>
