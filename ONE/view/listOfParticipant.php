...
$Participant = $Event->getListOfParticipant($eventId); 
?>
<!DOCTYPE html>
<html>
<title>ONE</title>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">List Of Participants</p>
  </header>
  ...
  {	
	 ...
	 {	
		...
		$participantType = $row['userTypeID'];
		$participantName = $row['userFullname'];
	  	$participantPhone = $row['userPhone'];
		?>
        <tr>
        	<td><?php echo $i; ?></td>
    		<td><a href="profileSingle.php?id=<?php echo $participantId;?>&type=<?php echo $participantType; ?>"><?php echo $participantName; ?></a></td>
    		<td><?php echo $participantPhone; ?></td>
  		</tr>
        <?php
		 $i++;
	 }
  ...
  <br>
  <button onClick="goBack()" class="btn" style="width: 8%">Back</button>
