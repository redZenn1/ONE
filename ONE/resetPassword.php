...
<div class="formbg">
      <center>
      <form class="modal-content animate" name="resetForm" method="post">
      <label for="password"><b>Menetapkan semula kata laluan</b></label></center><br />
      <label for="password"><b>Masukkan kata laluan yang baru</b></label>
      <input type="text" placeholder="Masukkan kata laluan" name="password" id="password" /required>
		<br><br>
      <label for="psw"><b>Pengesahan kata laluan yang baru</b></label>
      <input type="password" placeholder="Masukkan kata laluan" name="userPass" id="userPass" /required>
      <br><br>
    

      <div class="clearfix">
        <center><a href="login.html"><input type="button" class="btnLogin" name="Submit" id="btnLogin" value="Hantar" onClick="validateUser('login');" /></a>
        </form>
        </center>
      </div>
    </div>
