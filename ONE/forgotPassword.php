...
<form class="formbg" name="forgotForm" method="post">
       <center>
        <label for="password"><b>Alamak! Untuk menetapkan semula kata laluan, sila masukkan e-mel anda</b></label></center>
        
      <input type="text" placeholder="Masukkan e-mel" name="email" id="email" /required>
      <br><br>
      <center><a href="resetpassword.html"><input type="button" class="btnLogin" name="Hantar" id="btnLogin" value="Hantar" onClick="validateUser('forgot');" /></a></center><br />
    </div>
</div>
